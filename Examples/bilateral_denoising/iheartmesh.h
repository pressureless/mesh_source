...
struct iheartmesh {
        ...
        const int & i)
    {
        ...
        for(int f : Faces_0(i)){
            ...
            std::tuple< int, int > tuple_1 = NeighborVerticesInFace(f, i);
            int j = std::get<0>(tuple_1);
            int k = std::get<1>(tuple_1);
    ...
    struct Neighborhoods {
            ...
            const int & f)
        {
            ...
            std::tuple< int, int > tuple_3 = NeighborVerticesInFace(f, vs[1-1]);
